securecode = new Uint8Array(1);
window.crypto.getRandomValues(securecode);
securecodeString=securecode[0]+'';
materialAdmin
    .config(function ($stateProvider, $urlRouterProvider){
        ...
        $stateProvider
            ...
            .state ('widgets.mapping-attributes', {
                url: '/mapping-attributes',
                templateUrl: 'views/mapping-attributes.html',
            })
        .state ('widgets.mapping-categories', {
                url: '/mapping-categories',
                templateUrl: 'views/mapping-categories.html',
            })
          .state ('widgets.add-products-magento', {
                url: '/add-products-magento',
                templateUrl: 'views/add-products-magento.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
                        ...
                        return $ocLazyLoad.load ([
                            ...
                            },
                            {
                                ...
                                files: [
                                    ...
                                    'vendors/bower_components/moment/min/moment.min.js',
                                    'vendors/bower_components/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js',
                                    'vendors/bower_components/summernote/dist/angular-summernote.min.js',
                                    'vendors/fileinput/fileinput.min.js',
                                    'vendors/bower_components/chosen/chosen.jquery.js',
                                    'vendors/bower_components/angular-chosen-localytics/chosen.js',
                                    'vendors/bower_components/angular-farbtastic/angular-farbtastic.js'
            ...
            .state ('pages.invoice', {
             ...
             .state ('pages.register', {
                url: '/register'+securecodeString,
                templateUrl: 'views/register.html'
            })
             .state ('pages.changepass', {
                url: '/changepass'+securecodeString,
